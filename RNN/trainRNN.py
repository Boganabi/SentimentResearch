# written as follows here: https://levelup.gitconnected.com/painless-classification-model-using-rnn-b90cb0982543
...
with io.open("tokenizerRNN.json", 'w', encoding="utf-8") as f:
